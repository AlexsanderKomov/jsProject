                    ...
                    return (function () {
                      ...
                      if (-1 === _ || 'string' == typeof _) {
                        ...
                        if ('string' == typeof _) T = _.split(',');
                          ...
                          for (M = 0; M < k.matches.length; M++)
                            T.push(M.toString());
                        if (void 0 !== l.excludes[e]) {
                          for (
                            var j = T.slice(), D = 0, A = l.excludes[e].length;
                            D < A;
                            D++
                          ) {
                        ...
                        for (var C = 0; C < T.length; C++) {
                          (M = parseInt(T[C])),
                            (m = []),
                            (i =
                              ('string' == typeof _ && v(h, M, w)) ||
                              E.slice());
                          var R = k.matches[M];
                          if (R && s(R, [M].concat(o), c)) r = !0;
                          else if (
                            (0 === C && (S = !0),
                            R &&
                              R.matches &&
                              R.matches.length > k.matches[0].matches.length)
                          )
                            break;
                          (a = m.slice()), (h = O), (m = []);
                          for (var L = 0; L < a.length; L++) {
                            var F = a[L],
                              I = !1;
                            (F.match.jit = F.match.jit || S),
                              (F.alternation = F.alternation || w),
                              x(F);
                        ...
                        r = s(k.matches[_] || t.matches[_], [_].concat(o), c);
                      if (r) return !0;
                    })();
                  if (
                    r.isQuantifier &&
